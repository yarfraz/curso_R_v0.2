...
# Otra forma de hacer todo este proceso es ir a la pestaña "Packages" de la parte inf. derecha
...
setwd("direccion de la carpeta destino")
  ...
  # 2. Ve a la pestaña Files en la parte inf. derecha
...
# el resultado te llevara a la pestaña Help para que veas la documentacion de la funcion
...
# que un extraño en internet haya conseguido una solucion
